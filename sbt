...
declare -r sbt_snapshot_version=0.13.2-SNAPSHOT
...
declare -r default_jvm_opts="-Dfile.encoding=UTF8 -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005"
